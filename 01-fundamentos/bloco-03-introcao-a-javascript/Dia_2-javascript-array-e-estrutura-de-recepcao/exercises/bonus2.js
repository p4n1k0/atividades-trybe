...
for (let indexlinha = 0; indexlinha < n; indexlinha += 1) { // enqto indice de linha for menor q 6; indice soma + 1, faz a volta, soma dnv até chegar no indice 5;
    ...
    espaco = espaco + asteristico; // após impressão da primeira volta, variavel espaco recebe ela msma + simbolo de asteristico, para formar a proxima linha de 4 asteristico
}
