...
var LocalDbModel = /** @class */ (function () {
    ...
    ;
    LocalDbModel.prototype.findIndexById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var index;
            return __generator(this, function (_a) {
                index = db.findIndex(function (character) { return character.id === id; });
                if (index < 0)
    ...
    ;
    LocalDbModel.prototype.update = function (id, character) {
        return __awaiter(this, void 0, void 0, function () {
            var indexToUpdate;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.findIndexById(id)];
                    case 1:
                        indexToUpdate = _a.sent();
    ...
    ;
    LocalDbModel.prototype["delete"] = function (id) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    ;
    LocalDbModel.prototype.getAll = function () {
        return __awaiter(this, void 0, void 0, function () { return __generator(this, function (_a) {
            return [2 /*return*/, db];
        }); });
    };
    ;
    LocalDbModel.prototype.getById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var indexToGet;
            return __generator(this, function (_a) {
                switch (_a.label) {
